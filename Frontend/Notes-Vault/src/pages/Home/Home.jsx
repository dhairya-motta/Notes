...
//          />
//        ))}  
//     </div>):(<EmptyCard imgSrc={isSearch?NoDataImg:AddNoteImg} message={isSearch?`Oops! No notes found matching your search.`:`Start Creating your first note Click the 'Add' button to jot down your thoughts,ideas and reminders, Let's get started`}/>)}

//    </div>
//    <button className='w-16 h-16 flex items-center justify-center rounded-2xl bg-blue-400 hover:bg-blue-950 absolute right-10 bottom-10 ' onClick={()=>{
//     setOpenAddEditModal({isShown:true,type:'add',data:null});
//    }}>
...
//     }}
//     contentLable=''
//    className='w-[90%] max-w-xl bg-white rounded-md mx-auto mt-14 p-6 overflow-visible'
